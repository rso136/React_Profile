			...
			<div className = "row">
				<div className="col-md-12" id="bioBox">
					...
					<div id="about">
					  ...
					  <p>My <a href="Richard_Oh_Resume.pdf"><u>background</u></a> is rather diverse having studied English Literature in college and then biblical studies for graduate school. I am now a web developer with full stack experience in a variety of technologies. I consider myself a lifelong learner and have enjoyed the variety of experiences I have walked through in life. I hope to have the opportunity to share my skills and ideas with you. <i>(Note: This page was created to demonstrate ReactJS functionality. For my actual portfolio page, please click <a target="_blank" href="https://www.richardsoh.com"><u>here.)</u></a></i></p>	
